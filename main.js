...
var reporter_1 = require("./sources/reporter");
var eventAggregator = event_aggregator_1.default.getInstance();
var reporter = reporter_1.default.getInstance();
var wrapper;
function onTickReportSell(params) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, reporter.report('sell', params)];
                case 1:
                    _a.sent();
...
function start(interval, params, Wrapper) {
    var pairs = getPairs(params);
    var theParams = getParams(params);
    wrapper = new Wrapper();
